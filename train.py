...
tf.flags.DEFINE_string('X', 'datasets/tfrecords/man.tfrecords',
                       'X tfrecords file for training, default: datasets/tfrecords/man.tfrecords')
tf.flags.DEFINE_string('Y', 'datasets/tfrecords/woman.tfrecords',
                       'Y tfrecords file for training, default: datasets/tfrecords/woman.tfrecords')
