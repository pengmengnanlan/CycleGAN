...
tf.flags.DEFINE_string('XtoY_model', 'man_to_woman.pb', 'XtoY model name, default: man_to_woman.pb')
tf.flags.DEFINE_string('YtoX_model', 'woman_to_man.pb', 'YtoX model name, default: woman_to_man.pb')
