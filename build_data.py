...
tf.flags.DEFINE_string('X_input_dir', 'datasets/a_resized',
                       'X input directory, default: datasets/a_resized')
tf.flags.DEFINE_string('Y_input_dir', 'datasets/a_resized',
                       'Y input directory, default: datasets/a_resized')
tf.flags.DEFINE_string('X_output_file', 'datasets/tfrecords/man.tfrecords',
                       'X output tfrecords file, default: datasets/tfrecords/man.tfrecords')
tf.flags.DEFINE_string('Y_output_file', 'datasets/tfrecords/woman.tfrecords',
                       'Y output tfrecords file, default: datasets/tfrecords/man.tfrecords')
